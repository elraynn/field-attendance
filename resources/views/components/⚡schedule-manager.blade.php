...
<div class="max-w-4xl mx-auto py-10 px-4">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-2">
            <a href="{{ route('schedules.calendar') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm hover:bg-gray-50">
                Lihat Kalender
            </a>
            <a href="{{ route('schedules.bulk') }}" class="px-4 py-2 border border-gray-300 rounded-md text-sm hover:bg-gray-50">
                Assign Massal
            </a>
